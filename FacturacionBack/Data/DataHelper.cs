...
namespace FacturacionBack.Data
{
    public class DataHelper
    {
        ...
        private DataHelper()
        {
            _connection = new SqlConnection("Data Source=DESKTOP-150RNKI\\SQLEXPRESS;Initial Catalog=proyectoRepository;Integrated Security=True;Trust Server Certificate=True");
        }
